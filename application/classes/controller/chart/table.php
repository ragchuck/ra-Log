...
//                        );
            case 'month':
                ...
                $max_date = Arr::path($data_sum, "ACTUAL.$year.$month.MAX.0", 0);
                $max_actual = Arr::path($data_sum, "ACTUAL.$year.$month.MAX.1", 0);
                $actual = Arr::path($data_sum, "ACTUAL.$year.$month.SUM", 0);
