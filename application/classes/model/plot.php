...
class Model_Plot extends Model_Backbone
{
    ...
    /**
     * Column name or expression for the xAxis values
     * @var string
     */
    public $column_name_x;
    /**
     * Column name or expression for the yAxis values
     * @var string
     */
    public $column_name_y;

    /**
     * Name of the table, from which the data is selected
     * @var string
     */
    public $table_name;
