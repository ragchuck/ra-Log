...
class Import
{
    ...
    public function import_file($file)
    {
        ...
        try {
            Kohana::$log->add(Log::DEBUG, "Import start (:file)",
                array(':file' => $file));
            ...
            $schema_name = $this->config->get('schema',
                self::$defaults['schema']);
        ...
        Kohana::$log->add(Log::DEBUG,
            "Import end [:i rows affected] (:file)",
            array(':i' => $cnt, ':file' => $file));
