...
return array(
	...
	// Nav
	"Dashboard" => "Dashboard",
	"System profile" => "Anlagensteckbrief",
	...
	"Please enter a valid date (ISO)." => "Bitte geben Sie ein gültiges Datum ein.",
	"Please enter a valid number." => "Geben Sie bitte eine Nummer ein.",
	"Please enter only digits." => "Geben Sie bitte nur Ziffern ein.",
	"Please enter a valid credit card number." => "Geben Sie bitte ein gültige Kreditkarten-Nummer ein.",
